...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'django-docker-starter-production.up.railway.app']

CSRF_TRUSTED_ORIGINS = [ 'https://django-docker-starter-production.up.railway.app' ]
